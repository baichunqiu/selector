...
import com.bcq.selector.adapter.ImagePagerAdapter;
import com.bcq.selector.entry.Image;
import com.bcq.selector.utils.VersionUtils;
import com.bcq.selector.view.MyViewPager;
...
public class PreviewActivity extends AppCompatActivity {
    ...
    public static void openActivity(Activity activity, ArrayList<Image> images,
        ...
        intent.putExtra(Selector.MAX_SELECT_COUNT, maxSelectCount);
        intent.putExtra(Selector.IS_SINGLE, isSingle);
        intent.putExtra(Selector.POSITION, position);
        activity.startActivityForResult(intent, Selector.RESULT_CODE);
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mMaxCount = intent.getIntExtra(Selector.MAX_SELECT_COUNT, 0);
        isSingle = intent.getBooleanExtra(Selector.IS_SINGLE, false);
        ...
        vpImage.setCurrentItem(intent.getIntExtra(Selector.POSITION, 0));
    }

    private void initView() {
        vpImage = findViewById(R.id.vp_image);
        tvIndicator = findViewById(R.id.tv_title);
    ...
    public void finish() {
        ...
        intent.putExtra(Selector.IS_CONFIRM, isConfirm);
        setResult(Selector.RESULT_CODE, intent);
        super.finish();
    }
}
