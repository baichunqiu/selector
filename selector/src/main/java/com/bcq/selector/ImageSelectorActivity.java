...
import com.bcq.selector.adapter.FolderAdapter;
import com.bcq.selector.adapter.ImageAdapter;
import com.bcq.selector.entry.Folder;
import com.bcq.selector.entry.Image;
import com.bcq.selector.entry.RequestConfig;
import com.bcq.selector.model.ImageModel;
import com.bcq.selector.utils.DateUtils;
...
public class ImageSelectorActivity extends AppCompatActivity {
    ...
    private void setResult(ArrayList<String> images, boolean isCameraImage) {
        ...
        intent.putStringArrayListExtra(Selector.SELECT_RESULT, images);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == Selector.RESULT_CODE) {
            if (data != null && data.getBooleanExtra(Selector.IS_CONFIRM, false)) {
